...
export default function AccountDetailPage() {
  ...
  async function refreshRate() {
    ...
    try {
      if (supportsLiveCrypto(currency)) {
        ...
        const result = await getMyrRate(currency);
