...
export default function VaultDashboard() {
  ...
  const [coachMessage, setCoachMessage] = useState('Local review. AI runs only when you tap Refresh.');
  ...
  function openQuickUpdate(account: Account) { setQuickAccount(account); setQuickCurrency(account.currency || 'MYR'); setQuickNative(String(account.native_balance ?? account.balance ?? 0)); setQuickRate(String(account.fx_rate ?? 1)); setQuickDate(today()); setQuickNote(''); setQuickRateMeta(account.currency === 'MYR' ? 'MYR base currency' : 'Saved rate'); }
