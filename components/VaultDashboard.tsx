...
const typeIcon: Record<string, typeof Wallet> = { checking: Landmark, savings: Landmark, cash: Wallet, investment: BarChart3, crypto: Coins, retirement: Landmark, property: Home, loan: CreditCard, credit: CreditCard };
...
export default function VaultDashboard() {
  ...
  async function loadData() {
    ...
    if (!fullResult.error && fullResult.data) {
      setAccounts(fullResult.data as Account[]);
    } else {
  ...
  async function refreshQuickRate() {
    ...
    try {
      ...
      setStatus(error instanceof Error ? error.message : 'Unable to refresh rate.');
